    ...
    <div class="card">
        ...
        <div class='card-views'>
          ...
          <div class='card-shares'>
            <i class="fa fa-heart favorite-button" aria-hidden="true" onclick="addToFavorites(this, '${array[i].url}', '${array[i].img}', '${array[i].name}', '${array[i].discount}', '${array[i].views}')"></i><br>
...
function favoritesNextPage(previous, next, pageCountContainer, array, container){
  if(favoritesCurrentPage < totalPages(array)){ favoritesCurrentPage++};
  defaultCardBuilder(previous, next, pageCountContainer, favoritesCurrentPage, array, container);
}
